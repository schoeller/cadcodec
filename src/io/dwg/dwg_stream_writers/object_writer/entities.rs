...
impl<'a> DwgObjectWriter<'a> {
    ...
    /// dangling. ACSH_HISTORY_CLASS is now written (Phase A
    /// 2026-09-23): pointers to it stay live; pointers to elided node
    /// classes (EXTRUSION, SWEEP, primitives, BREP) go NULL.
