...
- **Loft** (`raw_tail`): an all-short `[1.0]` head, then raw BD
  ...
  (`[2.5, 5.0, pi/2, pi/2]`). The strict BD walk from the head
  derails on non-BD regions between the values (the landed
  fixture's drag-residue entries 2.0/2.0/0.3 among them) — the
